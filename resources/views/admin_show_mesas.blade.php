    ...
    <aside class="bg-dark-sidebar border-end border-dark-custom d-flex flex-column justify-content-start flex-shrink-0" style="width: 300px;">
        <div>
            ...
            <div class="p-3 border-bottom border-dark-custom d-flex items-center align-items-center gap-3">
                ...
                <div>
                    <h1 class="h6 font-bold m-0 text-white fw-bold">Catedral</h1>
        ...
        <section class="p-3 border-bottom border-dark-custom d-flex flex-wrap gap-3 align-items-center justify-content-between flex-shrink-0" style="background-color: rgba(17, 24, 39, 0.2);">
            ...
            <div class="btn-group p-1 bg-dark-sidebar rounded-3 border border-dark-custom">
                <button onclick="setZone('salon')" id="zone-salon" class="btn btn-sm btn-dark active fw-semibold rounded-2 px-3">
                    <i class="fa-solid fa-couch me-2"></i>Salón Catedral
                </button>
                
                <button onclick="setZone('terraza')" id="zone-terraza" class="btn btn-sm text-secondary fw-semibold rounded-2 px-3">
                    <i class="fa-solid fa-vihara me-2" style="color: rgb(255, 255, 255);"></i>Terraza
                </button>
        ...
        <div class="flex-grow-1 d-flex min-vh-0 position-relative overflow-hidden">
            ...
            <div id="view-map" class="flex-grow-1 overflow-auto p-4 d-flex align-items-center justify-content-center floorplan-grid user-select-none position-relative">
                ...
                <div id="floor-container" class="bg-dark-card-soft rounded-4 border border-dark-custom position-relative overflow-hidden shadow-lg" style="width: 1150px; height: 550px;">
                    ...
                    <div id="visual-decor-bar-1" class="position-absolute top-0 bg-dark-sidebar border-bottom border-start border-dark-custom d-flex align-items-start justify-content-center rounded-bottom-start-3 text-secondary fw-bold" style="left: 0%; width: 350px; height: 100%; font-size: 12px; letter-spacing: 2px;">
                        <span class="rotate-90 mt-3">SALON PRINCIPAL</span>
                    </div>
                    <div id="visual-decor-bar-2" class="position-absolute top-0 bg-dark-sidebar border-bottom border-start border-dark-custom d-flex align-items-center justify-content-center rounded-bottom-start-3 text-secondary fw-bold" style="left: 43%; width: 180px; height: 50px; font-size: 9px; letter-spacing: 2px;">
                        <span class="rotate-90">CATEDRAL</span>
                    </div>

                     <div id="visual-decor-bar-3" class="position-absolute bg-dark-sidebar border-bottom border-start border-dark-custom d-flex align-items-start justify-content-center rounded-bottom-start-3 text-secondary fw-bold" style="left: 70%; top: %; width: 350px; height: 100%; font-size: 9px; letter-spacing: 2px;">
                        <span class="rotate-90 mt-3">BALCON</span>
                    </div>

                   

                     <div id="visual-decor-kitchen-2" class="position-absolute bg-dark-sidebar border-top border-start border-end border-dark-custom d-flex align-items-center justify-content-center rounded-top-3 text-secondary fw-bold" style="left: 30%; bottom: 0%; width: 41%; height: 55px; font-size: 12px; letter-spacing: 1px;">
                        BARRA
                    </div>
