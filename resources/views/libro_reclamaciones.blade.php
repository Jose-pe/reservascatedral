            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="mb-0 text-muted"><strong>{{ 'Catedral Restaurant' }}</strong> | RUC: 10452440208</p>
                        <small class="text-muted">Cuesta Almirante 246 - Plaza de Armas Cusco -Perú</small>
                    </div>
